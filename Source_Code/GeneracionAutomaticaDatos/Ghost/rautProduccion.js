...
function createPage (title, contenido){
  ...
  cy.visit('https://hadaangel.ghost.io/ghost/#/pages', {timeout:50000})
  ...
  describe('Login', function(){
      ...
      it('Fail', () => {
          cy.visit('https://hadaangel.ghost.io/ghost/#/signin')
 ...
 describe('Create', function(){
    it('Post', () => {
        ...
        cy.visit('https://hadaangel.ghost.io/ghost/#/posts?type=draft', {timeout : 50000 } )
        ...
        cy.contains('Publish').click()
        cy.get('footer[class="gh-publishmenu-footer"]').find('button[class="gh-btn gh-btn-blue gh-publishmenu-button gh-btn-icon ember-view"]').click()
        cy.visit('https://hadaangel.ghost.io/ghost/#/posts', {timeout : 50000 } )
        cy.screenshot();
        cy.wait(2000)
      })
    })
